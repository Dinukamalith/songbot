...
- **Creator :** [Dinuka_Malith](https://Github.com/Dinukamalith)
...
def a(client, message):
    ...
    try:
        ...
        rep = f'❍📖 <b>Title:</b> <a href="{link}">{title}</a>\n❍⏳ <b>Duration:</b> <code>{duration}</code>\n❍📤 <b>Uploaded By:</b> <a href="https://t.me/szsongdown_bot">szsongdown_bot</a>'
        ...
        m.edit('**Something Went Wrong Report This at @szteambots!!**')
        print(e)
    try:
...
async def lrsearch(_, message: Message):  
    ...
    xxx = f"""
**Lyrics Search Powered By Ѕz ΜυЅις Dσшπlσλdεг Bot**
